...
export declare function closeDb(targetDb?: Database.Database): void;
...
export declare function validateMemory(db: Database.Database, id: number, agentId?: AgentId): boolean;
export interface ContradictionResult {
    contradictedIds: number[];
}
export declare function detectContradictions(db: Database.Database, embedding: Float32Array, newContent: string, projectId?: string | null): ContradictionResult;
export declare function markContradiction(db: Database.Database, idA: number, idB: number): void;
export declare function getMemoriesByAgent(db: Database.Database, agentId: AgentId): Memory[];
